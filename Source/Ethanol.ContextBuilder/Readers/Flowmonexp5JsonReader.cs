...
namespace Ethanol.ContextBuilder.Readers
{
    ...
    /// 1. Reading data from a file through the derived <see cref="FileReader"/> class.
    /// 2. Continuously fetching data from an open TCP socket using the derived <see cref="TcpReader"/> class.
