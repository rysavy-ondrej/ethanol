...
namespace Ethanol.Demo
{
    ...
    public class ArtifactFlow : Artifact
    {
        ...
        public override IEnumerable<FactBuilder> Builders => new FactBuilder[] { FactLoaders.Common.ServiceDomainName, FactLoaders.Common.AdjacentFlow<ArtifactFlow>(TimeSpan.FromMinutes(10)) };
    }
}