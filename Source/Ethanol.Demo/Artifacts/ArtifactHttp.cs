...
namespace Ethanol.Demo
{
    ...
    public class ArtifactHttp : Artifact
    {
        ...
        public override IEnumerable<FactBuilder> Builders => new FactBuilder[] { FactLoaders.Common.ServiceDomain, FactLoaders.Common.ÄdjacentFlow<ArtifactHttp>(TimeSpan.FromMinutes(10)) };
    }
}