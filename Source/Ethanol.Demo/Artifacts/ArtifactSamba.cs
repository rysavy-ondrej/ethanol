...
namespace Ethanol.Demo
{
    ...
    public class ArtifactSamba : Artifact
    {
        ...
        public override IEnumerable<FactBuilder> Builders => new FactBuilder[] { FactLoaders.Common.DomainName, FactLoaders.Common.Surrounding<ArtifactSamba>(TimeSpan.FromMinutes(10)) };
    }
}