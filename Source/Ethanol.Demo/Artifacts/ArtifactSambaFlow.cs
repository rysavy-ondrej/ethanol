...
namespace Ethanol.Demo
{
    ...
    public class ArtifactSambaFlow : Artifact
    {
        ...
        public override IEnumerable<ArtifactBuilder> Builders => new ArtifactBuilder[] { FactLoaders.Common.DomainName, FactLoaders.Common.Surrounding<ArtifactSambaFlow>(TimeSpan.FromMinutes(10)) };
    }
}