...
namespace Ethanol.Demo
{
    ...
    public class ArtifactTcp : Artifact
    {
        ...
        public override IEnumerable<FactBuilder> Builders => new FactBuilder[] { FactLoaders.Common.ServiceDomain, FactLoaders.Common.ÄdjacentFlow<ArtifactTcp>(TimeSpan.FromMinutes(10)) };
    }
}