...
namespace Ethanol.Demo
{
    public static partial class FactLoaders
    {
        ...
        {
            public static FactBuilder Reverse = new FactBuilder<ArtifactTls, ArtifactTls>("ReverseFlow", (tls, other) => tls.EndPoint(other.DstIp, other.SrcIp) && tls.Window(TimeSpan.FromMinutes(1), TimeSpan.FromMinutes(1), other));
        }
